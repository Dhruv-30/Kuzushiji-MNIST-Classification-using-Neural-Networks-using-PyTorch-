...
class Animator:
    ...
    def __init__(self, xlabel=None, ylabel=None, legend=None, xlim=None,
        ...
        self.config_axes = [functools.partial(d2l.set_axes, self.axes[i], xlabel[i], ylabel[i], 
...
def train_ch3(net, train_iter, test_iter, loss, num_epochs, updater, ylim=(None, (0, 1))):
